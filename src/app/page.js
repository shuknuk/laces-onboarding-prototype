...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#f9f6f3] text-[#2e2e2e] flex flex-col font-sans overflow-hidden">
      
      {/* Decorative Warm Light Background Circles */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#ffeedc]/50 blur-[130px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[60%] h-[50%] rounded-full bg-[#e8def1]/50 blur-[150px] pointer-events-none" />

      {/* Laces Premium Navigation Header */}
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between z-10">
        <a href="https://lacessports.com/" className="flex items-center gap-2 group">
          {/* Stylized Lacey Lacey Mascot mascot holder */}
          <div className="w-8 h-8 rounded-full bg-[#6a4682] flex items-center justify-center font-display font-black text-white text-xs shadow-sm border border-primary/20">
            L
          </div>
          <span className="font-display font-bold text-2xl tracking-tight text-[#6a4682]">
            laces
          </span>
        </a>
        <nav className="hidden md:flex items-center gap-8">
          <a href="#vibe-quiz" className="font-medium text-sm transition-colors hover:text-[#6a4682] text-[#6a4682]">Vibe Quiz</a>
          <a href="#cheat-sheets" className="font-medium text-sm transition-colors hover:text-[#6a4682] text-slate-500">Cheat Sheets</a>
          <a href="#sandbox" className="font-medium text-sm transition-colors hover:text-[#6a4682] text-slate-500">Alternative Search</a>
          <button className="btn-playful btn-playful-primary px-4 py-1.5 text-xs">Join Waitlist</button>
        </nav>
      </header>
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 z-10 flex flex-col items-center">
        ...
        <section className="text-center mt-12 mb-20 max-w-3xl flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#e8def1]/30 border border-primary/10 text-xs font-semibold text-[#5b3b75] mb-6">
            <SparklesIcon className="w-3.5 h-3.5 text-[#ff9e91]" />
            <span>Sports made <em className="text-primary not-italic">for you.</em></span>
          </div>
          
          <h1 className="font-display font-black text-4xl sm:text-7xl tracking-tight leading-[1.05] text-[#2e2e2e]">
            The Laces <span className="text-[#6a4682]">Warmup</span>
          </h1>
          
          <p className="mt-6 text-lg sm:text-xl text-slate-600 leading-relaxed max-w-2xl font-normal">
            Ditch the technical stats and dry box scores. We onboard you through high-speed reality TV drama, fashion runway walks, and juicy superstar rivalries. Just vibes and human connection.
          </p>
          
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <a 
              href="#vibe-quiz" 
              className="btn-playful btn-playful-primary px-6 py-3.5 text-sm"
              id="btn-take-quiz"
            >
            ...
            <a 
              href="#sandbox" 
              className="btn-playful btn-playful-secondary px-6 py-3.5 text-sm"
        ...
        {/* Section divider */}
        <div className="w-full h-px bg-[#ebe7e4] my-4" />

        {/* Pillar 1: The 'Vibe' Matchmaker Quiz */}
        <section id="vibe-quiz" className="w-full max-w-4xl py-16 flex flex-col items-center">
          <div className="text-center mb-12">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#6a4682]/70 mb-2">How it works</p>
            <h2 className="font-display font-black text-3xl sm:text-4xl text-[#2e2e2e]">
              Find Your Sport Matchmaker
            </h2>
            <p className="text-sm text-slate-500 mt-2 max-w-md mx-auto">
              Answer two quick lifestyle questions, and we'll translate your entertainment frequency into your matched sports drama.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            ...
            {/* Question 1 */}
            <div className="laces-card p-6 sm:p-8 flex flex-col">
              <span className="text-[10px] font-bold text-[#6a4682] uppercase tracking-widest">Question 01</span>
              <h3 className="text-lg font-bold text-[#2e2e2e] mt-2 mb-6">
              ...
              <div className="flex flex-col gap-4 mt-auto">
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border text-sm font-medium transition-all duration-300 flex items-start gap-3 ${
                    q1 === "A"
                      ? "bg-[#6a4682]/5 border-[#6a4682] text-[#6a4682]"
                      : "bg-white border-[#ebe7e4] text-slate-600 hover:border-[#6a4682]/20 hover:bg-slate-50/50"
                  }`}
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center border text-[10px] font-bold shrink-0 mt-0.5 ${
                    q1 === "A" ? "bg-[#6a4682] border-[#6a4682] text-white" : "border-slate-300 text-slate-400"
                  }`}>
                    A
                  </span>
                ...
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center border text-[10px] font-bold shrink-0 mt-0.5 ${
                    q1 === "B" ? "bg-[#6a4682] border-[#6a4682] text-white" : "border-slate-300 text-slate-400"
                  }`}>
                    B
                  </span>
            ...
            {/* Question 2 */}
            <div className="laces-card p-6 sm:p-8 flex flex-col">
              <span className="text-[10px] font-bold text-[#6a4682] uppercase tracking-widest">Question 02</span>
              <h3 className="text-lg font-bold text-[#2e2e2e] mt-2 mb-6">
              ...
              <div className="flex flex-col gap-4 mt-auto">
                ...
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center border text-[10px] font-bold shrink-0 mt-0.5 ${
                    q2 === "A" ? "bg-[#6a4682] border-[#6a4682] text-white" : "border-slate-300 text-slate-400"
                  }`}>
                    A
                  </span>
                ...
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center border text-[10px] font-bold shrink-0 mt-0.5 ${
                    q2 === "B" ? "bg-[#6a4682] border-[#6a4682] text-white" : "border-slate-300 text-slate-400"
                  }`}>
                    B
                  </span>
          ...
          {!showResult && (
            <div className="mt-8 text-center text-xs text-slate-400 italic">
              Answer both questions to automatically generate your custom narrative deck below.
            </div>
          )}
        </section>
        ...
        {showResult && (
          <section id="matched-vibe-section" className="w-full max-w-4xl py-12 scroll-mt-6">
            <div className="w-full text-center mb-10">
              <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#6a4682] mb-1 block">Pillar 02</span>
              
              {vibeResult === "F1" && (
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-50 text-red-600 border border-red-100 text-xs font-bold mt-2">
                  🏎️ Match Confirmed: Formula 1 Vibe
                </div>
              )}
              {vibeResult === "NBA" && (
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 border border-blue-100 text-xs font-bold mt-2">
                  🏀 Match Confirmed: NBA Narrative Vibe
                </div>
              )}
              {vibeResult === "HYBRID" && (
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f1ecf5] text-[#6a4682] border border-[#ebe7e4] text-xs font-bold mt-2">
                  🏎️ 🏀 Match Confirmed: Dual-Agent Vibe
                </div>
              )}
              
              <h2 className="font-display font-black text-3xl text-[#2e2e2e] mt-4">
            ...
            {vibeResult === "HYBRID" && (
              <div className="flex justify-center gap-3 mb-8">
                <button
                  ...
                  className={`btn-playful px-5 py-2 text-xs ${
                    currentTab === "F1"
                      ? "btn-playful-accent"
            ...
            <div className="relative">
              ...
              {/* Formula 1 Vibe Card */}
              {currentTab === "F1" && (
                <div className="laces-card overflow-hidden laces-f1-glow transition-all duration-500 animate-fadeIn">
                  
                  {/* Decorative Banner */}
                  <div className="w-full bg-gradient-to-r from-red-50 to-orange-50 p-6 sm:p-8 border-b border-[#ebe7e4] relative">
                    <div className="absolute top-4 right-4 text-[10px] font-extrabold uppercase px-2 py-0.5 rounded bg-red-100/50 text-red-700 border border-red-200">
                      High-Speed Reality TV
                    </div>
                    <span className="text-[10px] font-bold text-red-600 uppercase tracking-widest">The Match</span>
                    <h3 className="font-display font-black text-2xl sm:text-3xl text-[#2e2e2e] mt-1">
                  ...
                  <div className="p-6 sm:p-8 space-y-8">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-[#6a4682] uppercase tracking-wider mb-2">
                        🏎️ The 5-Year-Old Explanation
                      </h4>
                      <p className="text-base text-slate-700 leading-relaxed bg-[#fbf9f6] p-5 rounded-2xl border border-[#ebe7e4] italic">
                    ...
                    {/* Current Gossip */}
                    <div>
                      <h4 className="text-xs font-bold text-[#6a4682] uppercase tracking-wider mb-3">
                        🍿 Current Gossip: The Bitter Rivalries
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="p-4 rounded-2xl bg-white border border-[#ebe7e4] hover:border-red-300 hover:shadow-xs transition-all">
                          <span className="text-xs font-bold text-[#2e2e2e] block">Musical Chairs</span>
                        ...
                        <div className="p-4 rounded-2xl bg-white border border-[#ebe7e4] hover:border-red-300 hover:shadow-xs transition-all">
                          <span className="text-xs font-bold text-[#2e2e2e] block">Teammate Sabotage</span>
                          <span className="text-xs text-slate-500 mt-1 block">
                    ...
                    {/* The Script */}
                    <div className="p-5 rounded-2xl bg-red-50/40 border border-red-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                      ...
                      <button
                        ...
                        className="btn-playful btn-playful-secondary py-2.5 px-4 text-xs shrink-0"
                      >
                        {copiedText === "F1" ? (
                          <>
              ...
              {/* NBA Vibe Card */}
              {currentTab === "NBA" && (
                <div className="laces-card overflow-hidden laces-nba-glow transition-all duration-500 animate-fadeIn">
                  
                  {/* Decorative Banner */}
                  <div className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 p-6 sm:p-8 border-b border-[#ebe7e4] relative">
                    <div className="absolute top-4 right-4 text-[10px] font-extrabold uppercase px-2 py-0.5 rounded bg-blue-100/50 text-blue-700 border border-blue-200">
                      Superstar Drama Hub
                    </div>
                    <span className="text-[10px] font-bold text-blue-600 uppercase tracking-widest">The Match</span>
                    <h3 className="font-display font-black text-2xl sm:text-3xl text-[#2e2e2e] mt-1">
                  ...
                  <div className="p-6 sm:p-8 space-y-8">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="p-4 rounded-2xl bg-white border border-[#ebe7e4] hover:border-blue-300 hover:shadow-xs transition-all">
                          <span className="text-xs font-bold text-[#2e2e2e] block">Vibe Checks & Fashion Walks</span>
                          <span className="text-xs text-slate-500 mt-1 block">
                            The tunnel entrance is literally a runway. Players draft outfit styling contracts before games, and a bad fit is meme'd as aggressively as an airballed shot.
                          </span>
                        </div>
                        <div className="p-4 rounded-2xl bg-white border border-[#ebe7e4] hover:border-blue-300 hover:shadow-xs transition-all">
                          <span className="text-xs font-bold text-[#2e2e2e] block">Twitter Burners & Petty Likes</span>
                          <span className="text-xs text-slate-500 mt-1 block">
                    ...
                    {/* The Script */}
                    <div className="p-5 rounded-2xl bg-blue-50/40 border border-blue-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-1.5">
        ...
        {/* Section divider */}
        <div className="w-full h-px bg-[#ebe7e4] my-12" />

        {/* Pillar 3: The 'No Stupid Questions' Sandbox */}
        <section id="sandbox" className="w-full max-w-4xl py-12 scroll-mt-6">
          <div className="text-center mb-10">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#6a4682] mb-1 block">Pillar 03</span>
            <h2 className="font-display font-black text-3xl text-[#2e2e2e] mt-1">
          ...
          <div className="laces-card p-6 sm:p-8 flex flex-col gap-8">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full bg-white hover:bg-slate-50/50 focus:bg-white border border-[#ebe7e4] focus:border-[#6a4682]/50 outline-none text-sm text-[#2e2e2e] rounded-2xl pl-12 pr-4 py-4 transition-all"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-2.5">
              {filteredQuestions.map((q) => (
                <button
                  ...
                  className={`btn-playful px-4 py-2 text-xs transition-all flex items-center gap-2 cursor-pointer ${
                    activeQuestion === q.id
                      ? "btn-playful-accent"
                      : "btn-playful-secondary"
                  }`}
            ...
            {/* Explanation Sandbox */}
            <div className="relative min-h-[140px] flex items-center justify-center p-6 rounded-2xl bg-[#faf8f6] border border-[#ebe7e4] overflow-hidden">
              ...
              {activeQuestion ? (
                <div className="w-full animate-fadeIn flex flex-col sm:flex-row gap-4 items-start">
                  ...
                  {/* Friend avatar */}
                  <div className="w-10 h-10 rounded-full bg-[#6a4682] shrink-0 flex items-center justify-center font-display font-black text-sm text-white shadow-sm">
                    L
                  </div>
                  
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-[#2e2e2e]">Your Supportive Friend</span>
                      <span className="text-[9px] uppercase font-bold tracking-widest text-[#6a4682] bg-[#f1ecf5] px-2 py-0.5 rounded border border-[#ebe7e4]">
                        Zero Stats
                      </span>
                    </div>
                    
                    <p className="text-xs font-bold text-[#5b3b75] bg-[#f1ecf5] py-1 px-3 rounded-lg border border-[#ebe7e4] inline-block">
                ...
                <div className="text-center text-slate-400 max-w-sm flex flex-col items-center">
                  <UserGroupIcon className="w-8 h-8 text-slate-300 mb-2" />
                  <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">The Non-Judgmental Corner</p>
      ...
      <footer className="w-full border-t border-[#ebe7e4] bg-[#f5f1ed] mt-24 py-12 text-slate-500 text-xs z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <span className="font-display font-bold text-lg text-[#6a4682]">laces sports</span>
            <span className="text-slate-300">|</span>
            <span>Warmup Prototype 2026</span>
          </div>
          <div className="text-center sm:text-right font-medium">
            <p>Designed to address new sports fan imposter syndrome.</p>
          </div>
        </div>
      </footer>
